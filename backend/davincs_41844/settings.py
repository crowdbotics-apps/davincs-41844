"""
Django settings for davincs_41844 project.
...
ROOT_URLCONF = 'davincs_41844.urls'
...
WSGI_APPLICATION = 'davincs_41844.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "davincs_41844 API",
    "DESCRIPTION": "API documentation for davincs_41844 App",
    "VERSION": "v1",
}
